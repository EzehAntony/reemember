    ...
    <div className="fixed inset-0 bg-base-100/5 text-base-content backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-base-200 p-6 rounded-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center mb-6 ">
          <h2 className="text-2xl font-bold text-base-content">New Note</h2>
          <button
            onClick={ onClose }
        ...
        <form onSubmit={ handleSubmit } className="space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-base-300 border border-base-content/10 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50 text-base-content"
              required
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-3 bg-base-300 border border-base-content/10 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50 text-base-content min-h-[200px] max-h-[400px] resize-y"
              required
            />
          </div>

          <div>
            <label htmlFor="category" className="block text-sm font-medium text-base-content/70 mb-2">
              Category
            </label>
            <div className="flex flex-col gap-2">
              <select
                ...
                className="w-full px-4 py-3 bg-base-300 border border-base-content/3 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50 text-base-content"
              >
          ...
          <div>
            <label htmlFor="reminder" className="block text-sm font-medium text-base-content/70 mb-2">
              Reminder (optional)
            </label>
            <input
              type="datetime-local"
          ...
          <div className="flex justify-end gap-4 pt-4 border-t border-neutral">
            <button
              type="button"
              onClick={ onClose }
              className="px-4 py-2 text-base-content rounded-lg hover:text-base-200 hover:bg-base-content transition-colors duration-200"
            >
              Cancel
            </button>
            <button
